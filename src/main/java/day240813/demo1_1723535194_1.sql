...
-- 修改: 修改 students 字段名 hometown 为 hometown2
...
values (null, '小吴', '123xx098', 1, '1.jpg', 1, '2024-03-01', now(), now());

-- 如果你要插入的数据是给所有字段赋值，字段名可以省略，但是要安装顺序给它提供数据（虽然可以省略，最好写上）
insert into students values (null, '小林', 'xx0yy0zz', 1, '2.jpg', 1, '2024-03-01', now(), now());
...
update students set enrolled_at = '2024-03-01', updated_at = now();
